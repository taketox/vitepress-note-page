...
转载：[[译] NAT 穿透是如何工作的：技术原理及企业级实践（Tailscale, 2020）](https://arthurchiao.art/blog/how-nat-traversal-works-zh/)
...
> 更多关于 NAT 的内容，可参考 [(译) NAT - 网络地址转换](/linux/nat/nat)。 译注。
